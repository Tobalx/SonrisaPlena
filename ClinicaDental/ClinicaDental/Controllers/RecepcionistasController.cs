...
namespace ClinicaDental.Controllers
{
    public class RecepcionistasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Email")] Recepcionista recepcionista)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Email")] Recepcionista recepcionista)
        {
