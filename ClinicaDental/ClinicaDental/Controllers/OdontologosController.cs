...
namespace ClinicaDental.Controllers
{
    public class OdontologosController : Controller
    {
        ...
        {
            var appDbContext = _context.Odontologos.Include(o => o.CreadoPorAdministrador);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var odontologo = await _context.Odontologos
                .Include(o => o.CreadoPorAdministrador)
        ...
        {
            ViewData["CreadoPorAdministradorId"] = new SelectList(_context.Administradores, "Id", "Nombre");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Matricula,Especialidad,Email,CreadoPorAdministradorId,FechaCreacion")] Odontologo odontologo)
        {
            ...
            ViewData["CreadoPorAdministradorId"] = new SelectList(_context.Administradores, "Id", "Nombre", odontologo.CreadoPorAdministradorId);
            return View(odontologo);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Matricula,Especialidad,Email,CreadoPorAdministradorId,FechaCreacion")] Odontologo odontologo)
        {
            if (id != odontologo.Id)
            {
                return NotFound();
